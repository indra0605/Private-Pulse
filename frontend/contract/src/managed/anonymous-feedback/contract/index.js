...
const _descriptor_2 = new __compactRuntime.CompactTypeBytes(128);
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      submitResponse: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`submitResponse: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const _response_0 = args_1[1];
        const _responseSalt_0 = args_1[2];
        ...
        if (!(_response_0.buffer instanceof ArrayBuffer && _response_0.BYTES_PER_ELEMENT === 1 && _response_0.length === 128)) {
          __compactRuntime.typeError('submitResponse',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(_response_0).concat(_descriptor_0.toValue(_responseSalt_0)),
    ...
    this.impureCircuits = { submitResponse: this.circuits.submitResponse };
    this.provableCircuits = { submitResponse: this.circuits.submitResponse };
  }
  initialState(...args_0) {
    if (args_0.length !== 4) {
    ...
    const _surveyId_0 = args_0[1];
    const _question_0 = args_0[2];
    ...
    if (!(_surveyId_0.buffer instanceof ArrayBuffer && _surveyId_0.BYTES_PER_ELEMENT === 1 && _surveyId_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'anonymous-feedback.compact line 15 char 1',
                                 'Bytes<32>',
                                 _surveyId_0)
    }
    if (!(_question_0.buffer instanceof ArrayBuffer && _question_0.BYTES_PER_ELEMENT === 1 && _question_0.length === 64)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 2 (argument 3 as invoked from Typescript)',
                                 'anonymous-feedback.compact line 15 char 1',
                                 'Bytes<64>',
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(1n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(new Uint8Array(64)),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(1n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(_question_0),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _submitResponse_0(context, partialProofData, _response_0, _responseSalt_0) {
    const responseId_0 = this._getResponseId_0(_responseSalt_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(responseId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(_response_0),
  ...
  _getResponseId_0(_responseSalt_0) {
    return this._persistentHash_0([new Uint8Array([109, 105, 100, 110, 105, 103, 104, 116, 45, 115, 117, 114, 118, 101, 121, 58, 114, 101, 115, 112, 111, 110, 115, 101, 45, 105, 100, 58, 0, 0, 0, 0]),
                                   _responseSalt_0]);
  }
}
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'anonymous-feedback.compact line 13 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
